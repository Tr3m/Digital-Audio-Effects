...
plugin_select() {
    echo ++++++++++++++++++ && echo Plugins Available: && echo ++++++++++++++++++ && echo -e ""
    echo -e "1. Digital Delay\n2. Reverb\n3. IIR Filter\n4. Vibrado\n5. Chorus\n6. Flanger\n7. Distortion\n8. Compressor\n9. Limiter\n0. Exit\n"

    echo "Select a plug-in to build [0-9]:"
...
clear
echo -e "\e[1;33mChecking System for Git...\n"
if type git > /dev/null 2>&1; then
    echo -e "\e[1;32mGit found!\n\033[0m"
else
    echo -e "\e[1;31mError: Git not found in system!\n\033[0m"
    exit
fi

echo -e "\e[1;33mChecking System for CMake...\n"
if type cmake > /dev/null 2>&1; then
    echo -e "\e[1;32mCMake found!\n\033[0m"
else
    echo -e "\e[1;31mError: CMake not found in system!\n\033[0m"
    exit
fi
...
echo -e "\e[1;33mInitializing git submodules..."
